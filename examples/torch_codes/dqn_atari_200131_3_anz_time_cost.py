"""
Test of time cost based on 200131_3

Conclusion:
45% time cost on division in <forward>
45% time cost on torch.from_numpy line in <forward>
"""
import os
...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        x = np.divide(np.swapaxes(x, 3, 1), 256)
    ...
    for i_episode in range(n_episodes):
        ...
        for t in count():
            ...
            if memory.size >= batch_size:
                ...
                lp_wrapper(sampled_memory, counter=global_counter, writer=writer)
